...
<p class="post-no">No. 010 &nbsp;·&nbsp; coffee · cups</p>
...
<div class="dripper-block">
  <div class="dripper-header">
    ...
    <div>
      <p class="dripper-brand">Kimura Glass / 木村硝子店</p>
      <p class="dripper-name">ワサビ 10oz<span class="dripper-name-en">Wasabi 10oz Tumbler / 300cc</span></p>
    </div>
    <span class="use-badge">アイスコーヒー・ラテに</span>
  </div>

  <div class="dripper-body">
    <img src="/images/cups/wasabi-1.webp" alt="木村硝子 ワサビ 10oz" />
    <div class="pg-2">
      <img src="/images/cups/wasabi-2.webp" alt="ワサビ グラス 横から" />
  ...
  <div class="personal-note">
    ...
    <span>「フツーで気楽なコップ」というコンセプトそのまんま。でもそれが最高。アイスコーヒーを飲む専用グラスとして完全に固定されてます。</span>
  </div>
</div>
...
<div class="dripper-block">
  ...
  <div class="dripper-body">
    ...
    <div class="dripper-links">
      ...
      <a href="https://a.r10.to/hP5vEO" class="dripper-link dripper-link--rakuten" target="_blank" rel="noopener noreferrer nofollow">楽天（ソーサー）</a>
    </div>
  </div>
...
<div class="dripper-block">
  <div class="dripper-header">
    ...
    <div>
      <p class="dripper-brand">ORIGAMI / 美濃焼</p>
      <p class="dripper-name">ラテボウル（水色）<span class="dripper-name-en">ORIGAMI Latte Bowl</span></p>
    </div>
    <span class="use-badge">ラテ・カプチーノに</span>
  </div>
...
<div class="dripper-block">
  <div class="dripper-header">
    ...
    <div>
      <p class="dripper-brand">Varia</p>
      <p class="dripper-name">デュアルウォールグラス<span class="dripper-name-en">Dual Wall Glass</span></p>
    </div>
    <span class="use-badge">浅煎りホットに</span>
  </div>
  ...
  <div class="personal-note">
    <span class="note-icon">💬</span>
    <span>浅煎りの色が澄んできれい。コーヒーを「目でも飲む」ための一杯のために。二重構造で浮いて見える感じも好き。</span>
  </div>
</div>

<!-- ⑤ 波佐見焼 KOUSHUN Natural -->
<div class="dripper-block">
  <div class="dripper-header">
    <span class="dripper-num">05</span>
    <div>
      <p class="dripper-brand">波佐見焼 / KOUSHUN</p>
      <p class="dripper-name">Natural マグカップ<span class="dripper-name-en">Hasami Ware / Natural Series Mug</span></p>
    </div>
    <span class="use-badge">ほっとしたいとき</span>
  </div>

  <div class="dripper-body">
    <img src="/images/cups/hasami-1.webp" alt="波佐見焼 KOUSHUN Natural マグカップ" />
    <div class="pg-2">
      <img src="/images/cups/hasami-2.webp" alt="波佐見焼 マットな質感" />
  ...
  <div class="personal-note">
    <span class="note-icon">💬</span>
    <span>これを引っ張り出す日はなんかゆっくりしたい日。落ち着いた雰囲気で、手に持ったときの温かみがある。コーヒーにも日本茶にも合う。</span>
  </div>
</div>
